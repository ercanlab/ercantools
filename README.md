# ercantools <img src="man/figures/logo.jpg" align="right" height="139" alt="" />

<!-- badges: start -->
[![R-CMD-check](https://github.com/ercanlab/ercantools/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ercanlab/ercantools/actions/workflows/R-CMD-check.yaml)
[![pkgdown](https://github.com/ercanlab/ercantools/actions/workflows/pkgdown.yaml/badge.svg)](https://github.com/ercanlab/ercantools/actions/workflows/pkgdown.yaml)
...
- **Violin + box plots**: compare log2 fold-change or normalized
  binding counts between chromosomes.
...
- **T-test scatter plots**: chromosome-level Welch t-tests displayed
  as connected scatter plots to identify which chromosomes change
...
**[https://ercanlab.github.io/ercantools/](https://ercanlab.github.io/ercantools/)**
...
[https://ercanlab.github.io/ercantools/reference/](https://ercanlab.github.io/ercantools/reference/)
...
Open an issue at
[https://github.com/ercanlab/ercantools/issues](https://github.com/ercanlab/ercantools/issues)
and include:
...
- Use `ggplot2::` prefixes (not `library(ggplot2)`) inside functions
...
MIT © Daniel Garbozo — see [LICENSE](LICENSE) for details.

---

## Acknowledgments

- [Ercan Lab](https://sites.google.com/site/ercanlab/research) — New York University, for the
  biological context and experimental data that motivated this package.
---
